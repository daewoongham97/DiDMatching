...
calculate_truth_varying(beta_theta_1, beta_theta_0, beta_X_1, beta_X_0, mu_theta_1, 
                        mu_theta_0, mu_X_1, mu_X_0, sigma2_theta, sigma2_X, sigma2_pre,
                        num_pre = num_pre, rho = rho)

calculate_truth(beta_theta_1, beta_theta_0, beta_X_1, beta_X_0,
                mu_theta_1, mu_theta_0,
                mu_X_1, mu_X_0,
...
num_pre = 5
beta_theta_0 = runif(num_pre); beta_theta_1 = runif(1)
