...
make_data = function(N,
                     ...
                     p = 0.2, num_pre = 2, rho = c(0.3, 0.4), XZ_cor, seed = NULL) {
...
sigma_pre_tests = c(0.3, 0.45, 0.6, 0.75, 0.88, 0.92, 1.0, 1.1)
a = 0.3

#boundary is at sigma_pre = 0.656
...
for (j in 1:length(sigma_pre_tests)) {
    ...
    for (i in 1:K) {
        ...
        df = make_data(N, beta_theta_1, beta_theta_0, beta_theta_pre, 
                       ...
                       sigma2_pre = sigma_pre^2, num_pre = 2, rho = rho, XZ_cor = a, seed = i)
