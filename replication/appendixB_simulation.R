...
sim_res_T4_theta_par <- map_df( sigmas_larger,
                             ~ run_scenario( sigma_pre = .,
                                             beta_theta_0 = c( 0.6, 0.6, 0.6, 0.6 ),
                                             beta_theta_1 = 1.6,
                                             beta_x_0 = c( 0.6, 1.1, 1.1, 0.6 ),
                                             beta_x_1 = 1.3,
                                             beta_z_0 = c( 0.7, 0.7, 0.3, 0.3 ),
                             ...
                             .id = "sigma_pre" ) %>%
    mutate( sigma_pre = as.numeric(sigma_pre) )
saveRDS( sim_res_T4_theta_par, file = "results/sim_res_T4_theta_par.rds" )

plt <- make_result_plot( sim_res_T4_theta_par )
plt
...
#### Add in charactaristics of the simulation ####
...
sim_res_T4_theta_par = mutate( sim_res_T4_theta_par,
                               nT = 4,
                               cor = "yes",
                               two_theta = "yes"  )
...
all_res = bind_rows( main = sim_res_main,
                     ...
                     four_time_theta_par = sim_res_T4_theta_par,
